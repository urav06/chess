...
class TestKnight(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.default_game.add_piece((0, 4), Piece(type=PieceType.KING, color=Color.BLACK))
        self.default_game.add_piece((7, 4), Piece(type=PieceType.KING, color=Color.WHITE))
    ...
    def test_all_corner_moves(self) -> None:
        ...
        self.default_game.add_piece(Location(1, 1), Piece(type=PieceType.KNIGHT, color=Color.BLACK))
    ...
    def test_all_center_moves(self) -> None:
        ...
        expected_legal_moves = set(expected_legal_move_list)
        self.default_game.add_piece(Location(4, 4), Piece(type=PieceType.KNIGHT, color=Color.WHITE))
    ...
    def test_capture_knight_moves(self) -> None:
        ...
        expected_legal_moves = set(expected_legal_move_list)
        self.default_game.add_piece((3, 2), Piece(type=PieceType.KNIGHT, color=Color.BLACK))
        self.default_game.add_piece((2, 4), Piece(type=PieceType.KNIGHT, color=Color.WHITE))
        self.default_game.add_piece((1, 1), Piece(type=PieceType.KNIGHT, color=Color.WHITE))
    ...
    def test_check_center_moves(self) -> None:
        ...
        expected_legal_moves = set(expected_legal_move_list)
        self.default_game.add_piece((3, 2), Piece(type=PieceType.KNIGHT, color=Color.BLACK))
        self.default_game.add_piece((6, 4), Piece(type=PieceType.ROOK, color=Color.WHITE))
        calculate_legal_moves = set(list(self.default_game.legal_moves(color=Color.BLACK)))
        self.assertSetEqual(expected_legal_moves, calculate_legal_moves)
