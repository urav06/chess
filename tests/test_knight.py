...
class TestKnight(unittest.TestCase):
    ...
    def test_all_corner_moves(self):
        ...
        assert self.assertSetEqual(calculated_legal_moves, expected_legal_moves)
    ...
    def test_check_center_moves(self):
        ...
        expected_legal_moves = set(expected_legal_move_list)
        self.default_game.add_piece(location=Location(3, 3), piece=Piece(type=PieceType.KNIGHT, color=Color.BLACK))
